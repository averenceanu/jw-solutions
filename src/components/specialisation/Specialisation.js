  ...
  return (
    <div className="specialisation">
      ...
      <div className="specialisation--what-we-do">
        ...
        <div className="specialisation--title--second">
          <h1>Our goals</h1> 
        </div>
      </div>
      <div className='break-line'>{" "}</div>
      <div className="specialisation--statistics-main-content">
        <div className="specialisation-statistics"> 
      ...
      <div className="specialisation--shape"> 
        ...
        <div className="specialisation--image-div" style ={{backgroundImage: `url(./images/image1.jpeg)`, backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat', width: 'auto', height: '70vh'}}>
